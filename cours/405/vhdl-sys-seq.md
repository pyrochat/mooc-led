...
#### Les PROCESS ####
Les instructions séquentielles permettent de modéliser des comportements procéduraux constitués d’une suite d’action à exécuter en séquence. Les instructions séquentielles ne peuvent être utilisées que dans le corps d’un processus ou d’un sous-programme.
