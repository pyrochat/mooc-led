...
Dans notre exemple, seul le bit 3 est concerné par les interruptions. Dans la routine d'interruption, il n'y a donc pas besoin de regarder quel bit a produit l'interruption et c'est systématiquement le fanion 3 qui est remis a 0.
